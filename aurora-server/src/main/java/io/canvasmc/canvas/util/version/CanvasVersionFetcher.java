...
public class CanvasVersionFetcher implements VersionFetcher {
    ...
    private Status computeStatus() {
        ...
        if (true || buildNumber.isEmpty()) { // Aurora - no build API of our own, so never compare against CanvasMC build numbers
        ...
        try {
            ...
            GlobalConfiguration.LOGGER.error("Error parsing version information from Aurora's Jenkins API", thrown);
